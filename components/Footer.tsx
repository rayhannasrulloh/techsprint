        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
          ...
          <div>
            ...
            <ul className="space-y-6 text-sm font-light text-gray-400">
              <a href="https://www.instagram.com/techsprint2026">
                <li className="mb-3 flex items-center gap-3 hover:text-white transition-colors"><Instagram className="w-4 h-4 text-blue-500" /> @techsprint2026</li>
              </a>
          ...
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/techsprint2026" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-blue-600 hover:border-blue-500 transition-all">
