...
export default function FaultyTerminal({
  ...
  useEffect(() => {
    ...
    gl.clearColor(0, 0, 0, 0); // Transparent to blend properly
  ...
  return (
    <div ref={containerRef} className={`w-full h-full relative overflow-hidden ${className}`} style={{ width: '100%', height: '100%', ...style }} {...rest} />
  );
}
