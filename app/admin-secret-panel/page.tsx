...
const CP1_TIME = START_TIME + (6 * 60 * 60 * 1000);  // +6 Jam
const CP2_TIME = START_TIME + (12 * 60 * 60 * 1000); // +12 Jam
const CP3_TIME = START_TIME + (18 * 60 * 60 * 1000); // +18 Jam
...
export default function AdminPanelPage() {
  ...
  // Hitung sisa waktu atau waktu mundur
  ...
  // Menentukan Fase Saat Ini & Status Kunci
  ...
  if (isEnded) {
    ...
    if (now < CP1_TIME) { currentPhase = "Phase 1 (Towards CP1)"; lockStatus = "OPEN: CP 1"; lockColor = "text-emerald-400 bg-emerald-400/10"; }
    else if (now < CP2_TIME) { currentPhase = "Phase 2 (Towards CP2)"; lockStatus = "OPEN: CP 2"; lockColor = "text-emerald-400 bg-emerald-400/10"; }
    else if (now < CP3_TIME) { currentPhase = "Phase 3 (Towards CP3)"; lockStatus = "OPEN: CP 3"; lockColor = "text-emerald-400 bg-emerald-400/10"; }
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-6 gap-4">
          <div>
            <h1 className="text-3xl font-light tracking-wide flex items-center gap-3">
              <Database className="text-blue-500" /> Event Overview
            </h1>
